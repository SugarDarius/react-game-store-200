...
import { Header, ToggleTheme, GameStore } from '../core/components/exercice-09-hooks-correction/index.jsx'

export class Exercice09HooksCorrectionApp extends React.Component {
    constructor(props) {
        super(props);
